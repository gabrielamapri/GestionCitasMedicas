...
public class CitaService : ICitaService
{
    ...
    {
        // basic validation: paciente y medico existan
        ...
        // check paciente availability (no overlapping citas)
    ...
    public async Task<bool> CancelAsync(int id)
    {
        ...
        // only allow cancellation within business rules: appointment must be programada and in the future
        var now = DateTime.UtcNow;
    ...
    public async Task<CitaDto?> UpdateAsync(int id, CreateCitaDto dto)
    {
        ...
        // check medico availability excluding the current appointment
        ...
        // check paciente availability excluding current
        var pacienteCitas = await _citaRepo.GetByPacienteAsync(dto.PacienteId);
